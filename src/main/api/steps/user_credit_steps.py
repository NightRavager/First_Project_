...
class UserCreditSteps(BaseSteps):
    def create_account_credit(self, create_user_credit_request: CreateUserRequest):
    ...
    def credit_repay(self,create_user_credit_request: CreateUserCreditRequest, credit_repay_request: CreditRepayRequest):
        response = ValidateCrudRequester(
