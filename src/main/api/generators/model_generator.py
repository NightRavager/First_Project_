...
class RandomModelGenerator:
    ...
    def generate(cls: type) -> Any:
        ...
        for field_name, annotated_tipe in type_hints.items():
            rule = None
            actual_type = annotated_tipe

            if get_origin(annotated_tipe) is Annotated:
                actual_type, *annotations = get_args(annotated_tipe)
